...
def test_fixversion_filtering():
  candidate_versions = ['Run 1 (2019)', 'Shutdown 1 (2019)', 'Run 2 (2019)', 'Shutdown 2 (2019)', 'Diamond-DAWN 1.0', 'Diamond-Dawn 1.1', 'gda-8.30', 'gda-8.32', 'gda-8.34', 'Dawn 1.5', 'gda-8.36', 'gda-8.38', 'gda-8.40', 'gda-8.42', 'gda-8.44', 'DAWN 1.8', 'gda-8.46', 'gda-8.48', 'gda-8.50', 'gda-8.52', 'gda-9.0', 'gda-9.1', 'Dawn-1.9', 'Dawn-1.10', 'Dawn 2.0', '1.0', 'Run 5 (2017)', 'Shutdown 5 (2017)', 'Run 1 (2018)', 'Shutdown 1 (2018)', 'Run 2 (2018)', 'Shutdown 2 (2018)', 'Run 3 (2018)', 'Shutdown 3 (2018)', 'Run 4 (2018)', 'Shutdown 4 (2018)', 'Run 5 (2018)', 'Shutdown 5 (2018)']
  filtered_versions = jiradls.diamond.filter_versions(candidate_versions, run=2, year=2018)
  assert filtered_versions == [ 'Run 1 (2019)', 'Shutdown 1 (2019)', 'Run 2 (2019)', 'Shutdown 2 (2019)', 'Run 2 (2018)', 'Shutdown 2 (2018)', 'Run 3 (2018)', 'Shutdown 3 (2018)', 'Run 4 (2018)', 'Shutdown 4 (2018)', 'Run 5 (2018)', 'Shutdown 5 (2018)' ]

  filtered_versions = jiradls.diamond.filter_versions(candidate_versions, run=5, year=2017, return_map=True)
